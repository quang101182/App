# HANDOFF — Manga Studio, volet LECTURE NARRÉE (maj 22/09/2026, 09h20)
...
4. ✅ **v1.76.0 (21/09 23h20, `32c80ad`)** : bibliothèque par série + pochettes (AniList / image / page), suppression
   ...
   **ORDRE FIXÉ PAR QUANG (22/09 00h06)** : (1) **traduction des dialogues** ← EN COURS ; (2) musique de fond
   ...
   ✅ **v1.95.1** vidéo : 📜 en tête, choix de la voix, nom de fichier lisible ; pastille des coûts à droite. SUITE : 16 (chapitre
   précédent/suivant), 15 (groupe de vidéos), puis 9 (suivi, SANS plafond — décision Quang 09h00), 10 (hors-ligne DANS le téléphone).
