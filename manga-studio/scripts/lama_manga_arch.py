"""Architecture LaMa (FFC) de manga-image-translator (GPL-3.0), extraite telle quelle pour charger lama_large_512px.ckpt
sans le reste du depot. Source : manga_translator/inpainting/inpainting_lama_mpe.py (lignes 140-fin), 24/09/2026."""
