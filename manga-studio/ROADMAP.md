...
| 12 | **Bibliothèque rangée PAR MANGA** (Quang 21/09 19h29 : « ranger correctement par manga et ne pas tout afficher par chapitre ; dans les mangas, on verra bien sûr les chapitres ») : l'onglet 📚 montre d'abord les séries (couverture, nb de chapitres), un clic ouvre ses chapitres | la liste plate ne tiendra pas au-delà de quelques chapitres | 0 chapitre affiché hors de sa série ; ouvrir une série ≤ 1 clic. *Esthétique non prioritaire à ce stade (Quang), la structure l'est* |
