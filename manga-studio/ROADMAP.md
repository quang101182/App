...
| 📌 **À faire ensuite (Quang 22/09 05h15)** | **Ergonomie de la bibliothèque et des chapitres** : le bloc « Rafraîchir » (gros texte avant/après = rectangle haut pour rien) → fin et discret ; lignes de narration en ZONES FIXES (🗑 et boutons toujours au même endroit, quel que soit le texte) ; moins de pavés de texte ; rendu propre et professionnel. + **Visionneuse plein écran** (05h15) : boutons du bas trop bas sur SON smartphone (chevauchent le bas de l'écran), PC OK → les remonter (zone de sécurité). |  |  |
